...
public class DiffTGen1Test {
  ...
  @Test public void test11()  throws Throwable  {
	...
	List obj_list_7au3e = (List) MultivariateNormalDistribution.oref_map
			.get("density(double[])0");
	Object target_obj_7au3e = obj_list_7au3e.get(0);
	assertEquals(
			"(E)0,(C)org.apache.commons.math3.distribution.MultivariateNormalDistribution,(MSIG)density(double[])0,(I)0",
			0.10390401010734399d, ((Double) target_obj_7au3e).doubleValue(),
			1e-12);
  }
