...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-10.204747348944966));
      double[] doubleArray0 = new double[9];
      doubleArray0[0] = (double) 100;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-11.163632));
  ...
  public void test01()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(544.9779887411);
      double[] doubleArray0 = new double[7];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 100.0);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 544.9779887411);
  ...
  public void test02()  throws Throwable  {
      ...
      SimplexSolver simplexSolver0 = new SimplexSolver((-11.163632));
      simplexTableau0.numArtificialVariables = (-505);
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 4384.7);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
  ...
  public void test06()  throws Throwable  {
      ...
      doReturn(92.0, 235.410077011).when(linearConstraint0).getValue();
  ...
  public void test10()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-835.0423775));
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-443.8590924512133));
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 1205.076705435713);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 100);
      boolean boolean0 = simplexSolver0.isOptimal(simplexTableau0);
  ...
  public void test19()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-10.204747348944966));
      double[] doubleArray0 = new double[9];
      doubleArray0[1] = (-10.204747348944966);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-11.163632));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      Double[] doubleArray1 = new Double[4];
      doubleArray1[0] = (Double) (-10.204747348944966);
      doubleArray1[1] = (Double) (-10.204747348944966);
      doubleArray1[2] = (Double) (-10.204747348944966);
      doubleArray1[3] = (Double) 100.0;
      OpenMapRealVector openMapRealVector0 = new OpenMapRealVector(doubleArray1);
      Relationship relationship0 = Relationship.GEQ;
      LinearConstraint linearConstraint0 = mock(LinearConstraint.class, new ViolatedAssumptionAnswer());
      doReturn(openMapRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(0.0, 235.410077011).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      try { 
        simplexSolver0.optimize(linearObjectiveFunction0, linkedList0, goalType0, true);
      } catch(Exception e) {
