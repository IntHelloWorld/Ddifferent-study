...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-1006.809237381));
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = (-1006.809237381);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-2587.426));
  ...
  public void test03()  throws Throwable  {
      ...
      simplexTableau0.numArtificialVariables = (-552107674);
      simplexSolver0.solvePhase1(simplexTableau0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-544.73));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      Double[] doubleArray1 = new Double[4];
      doubleArray1[0] = (Double) 0.0;
      doubleArray1[1] = (Double) (-544.73);
      doubleArray1[2] = (Double) 0.0;
      doubleArray1[3] = (Double) (-544.73);
      ...
      doReturn((-792.07), doubleArray1[3]).when(linearConstraint1).getValue();
  ...
  public void test07()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[4];
      GoalType goalType0 = GoalType.MAXIMIZE;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 4309.032894);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      Double[] doubleArray1 = new Double[4];
      doubleArray1[0] = (Double) 0.0;
      doubleArray1[1] = (Double) (-544.73);
      doubleArray1[2] = (Double) 0.0;
      doubleArray1[3] = (Double) (-544.73);
      OpenMapRealVector openMapRealVector0 = new OpenMapRealVector(doubleArray1, 0.03253938271454488);
      Relationship relationship0 = Relationship.GEQ;
      LinearConstraint linearConstraint0 = mock(LinearConstraint.class, new ViolatedAssumptionAnswer());
      doReturn(openMapRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn((-792.07), doubleArray1[3]).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 1.4639131049537295);
      simplexSolver0.doIteration(simplexTableau0);
  }
  ...
  public void test12()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(1904.902357671203);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(1202.3359238048317, (-3.4273196804454846)).when(linearConstraint0).getValue();
  ...
  public void test20()  throws Throwable  {
      ...
      doReturn(openMapRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(100.0, doubleArray1[3]).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, simplexSolver0.goalType, false, 100);
      try { 
        simplexSolver0.solvePhase1(simplexTableau0);
  ...
  public void test23()  throws Throwable  {
      ...
      doReturn(openMapRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship1).when(linearConstraint0).getRelationship();
      doReturn(doubleArray1[3], doubleArray1[3]).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      GoalType goalType0 = GoalType.MINIMIZE;
      try { 
        simplexSolver0.optimize(linearObjectiveFunction0, linkedList0, goalType0, true);
