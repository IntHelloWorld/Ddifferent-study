...
public class CategoryPlot extends Plot implements ValueAxisPlot, 
	...
	public static int eid_zoomDomainAxes_double_PlotRenderingInfo_Point2D_boolean_7au3e = 0;

	public static int eid_zoomRangeAxes_double_PlotRenderingInfo_Point2D_7au3e = 0;

	public static int eid_zoomRangeAxes_double_PlotRenderingInfo_Point2D_boolean_7au3e = 0;
	...
	public static void clearORefMap() {
		...
		eid_zoomDomainAxes_double_PlotRenderingInfo_Point2D_boolean_7au3e = 0;
		eid_zoomRangeAxes_double_PlotRenderingInfo_Point2D_7au3e = 0;
		eid_zoomRangeAxes_double_PlotRenderingInfo_Point2D_boolean_7au3e = 0;
     ...
     * @since 1.0.3
     */
    public int getDomainAxisIndex_7au3e(CategoryAxis axis) {
     ...
     * @since 1.0.7
     */
    public int getRangeAxisIndex_7au3e(ValueAxis axis) {
	...
	public int getDomainAxisIndex(CategoryAxis axis) {
		...
		String msig_7au3e = "getDomainAxisIndex(CategoryAxis)"
				+ eid_getDomainAxisIndex_CategoryAxis_7au3e;
		try {
			o_7au3e = getDomainAxisIndex_7au3e(axis);
			FieldPrinter.print(o_7au3e,
					eid_getDomainAxisIndex_CategoryAxis_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getDomainAxisIndex_CategoryAxis_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(axis, eid_getDomainAxisIndex_CategoryAxis_7au3e,
	...
	public int getRangeAxisIndex(ValueAxis axis) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.plot.CategoryPlot";
		String msig_7au3e = "getRangeAxisIndex(ValueAxis)"
				+ eid_getRangeAxisIndex_ValueAxis_7au3e;
		try {
			o_7au3e = getRangeAxisIndex_7au3e(axis);
			FieldPrinter.print(o_7au3e, eid_getRangeAxisIndex_ValueAxis_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getRangeAxisIndex_ValueAxis_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(axis, eid_getRangeAxisIndex_ValueAxis_7au3e,
					c_7au3e, msig_7au3e, 2, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_getRangeAxisIndex_ValueAxis_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_getRangeAxisIndex_ValueAxis_7au3e++;
