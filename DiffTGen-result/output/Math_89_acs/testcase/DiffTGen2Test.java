...
public class DiffTGen2Test {
 ...
 -> 
  ...
  @Test public void test37()  throws Throwable  {
	...
	try {
		...
		if (not_thrown) {
			...
			List obj_list_7au3e = (List) Frequency.oref_map
					.get("addValue(Object)0");
			target_obj_7au3e = obj_list_7au3e.get(0);
			assertEquals(
					"(E)0,(C)org.apache.commons.math.stat.Frequency,(MSIG)addValue(Object)0,(I)0",
					"java.lang.IllegalArgumentException: Object must implement Comparable",
