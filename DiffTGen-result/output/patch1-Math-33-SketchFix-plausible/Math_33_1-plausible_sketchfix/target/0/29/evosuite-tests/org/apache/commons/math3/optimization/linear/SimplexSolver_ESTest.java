...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-2386.9519973048937), 2692);
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = (-2386.9519973048937);
      OpenMapRealVector openMapRealVector0 = new OpenMapRealVector(doubleArray0, (-485.830592021));
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(openMapRealVector0, 2070.662536854659);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      try { 
