...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(450.99, 0);
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(773.2755310979173, 0);
      ...
      doReturn(773.2755310979173, 1.0E-6, (double)0, 1233.966073271).when(linearConstraint0).getValue();
  ...
  public void test4()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(808.5296353636, 0);
      ArrayRealVector arrayRealVector0 = new ArrayRealVector(0, 0);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(arrayRealVector0, 0);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
