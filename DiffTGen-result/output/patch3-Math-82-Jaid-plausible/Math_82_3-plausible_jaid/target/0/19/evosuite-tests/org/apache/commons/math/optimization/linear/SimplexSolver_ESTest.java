...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver();
      OpenMapRealVector openMapRealVector0 = new OpenMapRealVector(527, 527);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(openMapRealVector0, 527);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
  ...
  public void test02()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(openMapRealVector0, (-4.187440266049497));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
  ...
  public void test04()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-1.218596059702));
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-549.474728));
      // Undeclared exception!
      try { 
        simplexSolver0.doIteration((SimplexTableau) null);
      } catch(NullPointerException e) {
  ...
  public void test10()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-974.585828225927));
      OpenMapRealVector openMapRealVector0 = new OpenMapRealVector(0);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(openMapRealVector0, 1.0E-12);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 464.23937685);
      boolean boolean0 = simplexSolver0.isOptimal(simplexTableau0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-882.574552706443));
      double[] doubleArray0 = new double[4];
      doubleArray0[2] = (double) 100;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-882.574552706443));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, (-882.574552706443));
      try { 
  ...
  public void test15()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver();
      double[] doubleArray0 = new double[4];
      doubleArray0[0] = (-882.574552706443);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-882.574552706443));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      try { 
