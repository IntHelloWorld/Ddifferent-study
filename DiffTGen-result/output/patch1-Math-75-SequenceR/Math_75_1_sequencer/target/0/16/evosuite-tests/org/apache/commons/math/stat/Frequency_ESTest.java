...
public class Frequency_ESTest extends Frequency_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-2498));
      frequency0.addValue((Comparable<?>) "Value \t Freq. \t Pct. \t Cum Pct. \n-2498\t1\t100%\t100%\n");
      double double0 = frequency0.getPct((-3052));
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue(796);
      double double0 = frequency0.getPct((Object) ":[M6-isNWJv-!sT");
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1437, 1437).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test05()  throws Throwable  {
      ...
      double double0 = frequency0.getPct((long) 3712);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue((-1354));
      double double0 = frequency0.getPct((long) (-1354));
  }
  ...
  public void test07()  throws Throwable  {
      ...
      frequency0.addValue((Comparable<?>) "Value \t Freq. \t Pct. \t Cum Pct. \n");
      double double0 = frequency0.getPct(1588);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-1126), 2666).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test09()  throws Throwable  {
      ...
      doReturn((-3748), 4152).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test10()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1789569706, 1789569706, 868, (-2341), (-2341)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test13()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-902L));
      double double0 = frequency0.getCumPct(1672L);
  }
  ...
  public void test16()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-3748), 4152, (-3748), 4389).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue('U');
  ...
  public void test17()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-1126), 2666, (-1126), 555, 555).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((Object) "Value \t Freq. \t Pct. \t Cum Pct. \n");
      long long0 = frequency0.getCount((-240));
  ...
  public void test18()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-3043L));
      long long0 = frequency0.getCumFreq((-3043L));
  }
  ...
  public void test41()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1437, 1437, 2251, 1437).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      Integer integer0 = new Integer(0);
      frequency0.addValue(integer0);
      Comparable<Object> comparable0 = (Comparable<Object>) mock(Comparable.class, new ViolatedAssumptionAnswer());
  ...
  public void test43()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1789569706, 1789569706, 868, (-2341)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      Comparable<Object> comparable0 = (Comparable<Object>) mock(Comparable.class, new ViolatedAssumptionAnswer());
      frequency0.addValue((-902L));
      double double0 = frequency0.getPct(comparable0);
  ...
  public void test52()  throws Throwable  {
      Comparator<String> comparator0 = (Comparator<String>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(3087).when(comparator0).compare(anyString() , anyString());
      Frequency frequency0 = new Frequency(comparator0);
