...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(1.0E-12, 1406.0, (-4898.042327941914), 1.0E-12).when(linearConstraint0).getValue();
  ...
  public void test01()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(246.32);
      double[] doubleArray0 = new double[5];
      doubleArray0[0] = 246.32;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 246.32);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
  ...
  public void test07()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver();
      ArrayRealVector arrayRealVector0 = new ArrayRealVector(100, 890.0);
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(arrayRealVector0, 3571.5);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
  ...
  public void test10()  throws Throwable  {
      ...
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(1.0E-12, 1406.0).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 1.0E-12);
  ...
  public void test11()  throws Throwable  {
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, (-768.65665606304));
      boolean boolean0 = simplexSolver0.isOptimal(simplexTableau0);
  }
