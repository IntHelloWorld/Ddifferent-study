...
public class ExtendedMessageFormat_ESTest extends ExtendedMessageFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("<Oox>(rh{", hashMap0);
  ...
  public void test03()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("aC{?~'3%):wXKTH", (Map) null);
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test05()  throws Throwable  {
      Locale locale0 = new Locale("xEE.1oRisWTu3Kb/zj");
      HashMap<NumberFormat, Integer> hashMap0 = new HashMap<NumberFormat, Integer>();
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat(":w1&a:U:#|t8{(>", locale0, hashMap0);
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("VqX{", locale0, hashMap0);
  ...
  public void test08()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("]\"U];4_Ut>xY9{mu", locale0);
      } catch(IllegalArgumentException e) {
         //
         // Unmatched braces in the pattern.
         //
  ...
  public void test10()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("Id!_%L.{ueK-3#3&y(");
      } catch(IllegalArgumentException e) {
         //
         // Unmatched braces in the pattern.
         //
  ...
  public void test11()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat("NT Xug");
      extendedMessageFormat0.applyPattern("NT Xug");
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      HashMap<MockDateFormat, String> hashMap0 = new HashMap<MockDateFormat, String>();
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat("V/aa%T$$n$y@!Hq", hashMap0);
      extendedMessageFormat0.applyPattern("jfrWNxfMm;h|x^<u");
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Locale locale0 = Locale.KOREAN;
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat(" l~.+\"qKM", locale0);
  ...
  public void test16()  throws Throwable  {
      ...
      Locale locale0 = new Locale("", "", "org.apache.commons.lang.text.StrMatcher");
      NumberFormat numberFormat0 = NumberFormat.getIntegerInstance(locale0);
      // Undeclared exception!
      try { 
        extendedMessageFormat0.setFormat(1094, numberFormat0);
      } catch(UnsupportedOperationException e) {
         //
         // no message in exception (getMessage() returned null)
         //
