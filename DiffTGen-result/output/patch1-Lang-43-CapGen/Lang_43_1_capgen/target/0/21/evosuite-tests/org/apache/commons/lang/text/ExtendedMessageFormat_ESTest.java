...
public class ExtendedMessageFormat_ESTest extends ExtendedMessageFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Locale locale0 = new Locale("{&UXFv", "{&UXFv", "");
      HashMap<Integer, ChoiceFormat> hashMap0 = new HashMap<Integer, ChoiceFormat>();
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("{&UXFv", locale0, hashMap0);
  ...
  public void test01()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat("]ts8", (Locale) null, hashMap0);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        extendedMessageFormat0.applyPattern("jb{bJkr");
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test05()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("yYcL: r{j1<}@.Z1Yf", (Map) null);
      } catch(IllegalArgumentException e) {
         //
         // can't parse argument number: j1<
         //
         verifyException("java.text.MessageFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("8$9= mqgNI$+MkT;.{", locale0);
      } catch(IllegalArgumentException e) {
         //
         // Unmatched braces in the pattern.
         //
  ...
  public void test10()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("{p3Y91yP~YI");
      } catch(IllegalArgumentException e) {
         //
         // Unmatched braces in the pattern.
         //
  ...
  public void test14()  throws Throwable  {
      Locale locale0 = new Locale("jb{bJkr");
      HashMap<MockDateFormat, MessageFormat> hashMap0 = new HashMap<MockDateFormat, MessageFormat>();
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("jb{bJkr", locale0, hashMap0);
      } catch(IllegalArgumentException e) {
         //
         // Invalid format argument index at position 3: b
         //
         verifyException("org.apache.commons.lang.text.ExtendedMessageFormat", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat(")c3x>d*^6mY}");
  ...
  public void test17()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = null;
      try {
        extendedMessageFormat0 = new ExtendedMessageFormat("#5_sF?U!%n/'{,#x", hashMap0);
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test19()  throws Throwable  {
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat("=`'M&/v:@$l(5");
      // Undeclared exception!
      try { 
        extendedMessageFormat0.setFormat((-2964), extendedMessageFormat0);
      } catch(UnsupportedOperationException e) {
         //
         // no message in exception (getMessage() returned null)
         //
  ...
  public void test20()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat(",s", locale0, hashMap0);
  ...
  public void test21()  throws Throwable  {
      ...
      ExtendedMessageFormat extendedMessageFormat0 = new ExtendedMessageFormat("", locale0, hashMap0);
      extendedMessageFormat0.applyPattern("=`'M&/v:@$l(5");
  }
}
