...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(1.1424354532164984);
      double[] doubleArray0 = new double[8];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-509.4274443614));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 1.1424354532164984);
  ...
  public void test04()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(2655.75065633613);
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, (-1170.0920220751));
      try { 
        simplexSolver0.doIteration(simplexTableau0);
      } catch(Exception e) {
         //
  ...
  public void test07()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(968.3266);
  ...
  public void test11()  throws Throwable  {
      ...
      doReturn(0.0, 659.9477600832452).when(linearConstraint0).getValue();
  ...
  public void test14()  throws Throwable  {
      ...
      doReturn(0.0, (-509.4274443614)).when(linearConstraint1).getValue();
  ...
  public void test15()  throws Throwable  {
      ...
      doReturn(relationship0, relationship1, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(0.0, 659.9477600832452, (-300.78), 100.0).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 100.0);
      LinearConstraint linearConstraint1 = mock(LinearConstraint.class, new ViolatedAssumptionAnswer());
      doReturn(openMapRealVector0).when(linearConstraint1).getCoefficients();
      doReturn(relationship0, relationship0, relationship1, relationship0, relationship0).when(linearConstraint1).getRelationship();
      doReturn(0.0, (-509.4274443614)).when(linearConstraint1).getValue();
      linkedList0.addFirst(linearConstraint1);
  ...
  public void test16()  throws Throwable  {
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      SimplexSolver simplexSolver0 = new SimplexSolver((-467.37398305189));
      Double[] doubleArray0 = new Double[8];
      Double double0 = new Double(2994.1075525);
      doubleArray0[1] = double0;
      doubleArray0[2] = doubleArray0[1];
      double[] doubleArray1 = new double[7];
      doubleArray1[0] = (double) doubleArray0[2];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray1, 1.0E-12);
      GoalType goalType0 = GoalType.MINIMIZE;
      try { 
