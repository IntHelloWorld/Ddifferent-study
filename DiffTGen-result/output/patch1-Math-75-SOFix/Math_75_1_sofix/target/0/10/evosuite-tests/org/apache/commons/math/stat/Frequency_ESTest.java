...
public class Frequency_ESTest extends Frequency_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(0, 9).when(comparator0).compare(any() , any());
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn((-3449), (-3449)).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-476));
  ...
  public void test02()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(3127, 3127).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test05()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-1881));
      double double0 = frequency0.getPct(892);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-476));
      double double0 = frequency0.getPct(1440);
  }
  ...
  public void test11()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(9, (-1469), (-1469)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test12()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1, 1, 1, 1).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-606L));
      double double0 = frequency0.getCumPct((-606L));
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue(4124);
  ...
  public void test14()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-606L));
      double double0 = frequency0.getCumPct(2391);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-476));
      long long0 = frequency0.getCount((long) 1440);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-476));
      long long0 = frequency0.getCount((-2985));
  }
  ...
  public void test41()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(3127, 3127, 3127, 3127, (-1)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0L);
      ...
      long long1 = frequency0.getCumFreq(comparable0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(3127, 3127, 3127, 3127).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0L);
      Comparable<Frequency> comparable0 = (Comparable<Frequency>) mock(Comparable.class, new ViolatedAssumptionAnswer());
  ...
  public void test44()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-3449), (-3449), 293, 293).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-476));
  ...
  public void test52()  throws Throwable  {
      ...
      frequency0.addValue((Comparable<?>) integer0);
      Comparable<Object> comparable0 = (Comparable<Object>) mock(Comparable.class, new ViolatedAssumptionAnswer());
      doReturn(1190, (-471), 0, 0, 0).when(comparable0).compareTo(any());
      doReturn("1190").when(comparable0).toString();
      frequency0.addValue(comparable0);
      // Undeclared exception!
      try { 
        frequency0.toString();
         ...
         //
         // codegen.java.lang.Comparable$MockitoMock$2098406128 cannot be cast to java.lang.Long
         //
  ...
  public void test59()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(0, 9, 0, (-1952), 4287).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-1881));
  ...
  public void test63()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1, 1, 1).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-606L));
      frequency0.addValue((Comparable<?>) "Value \t Freq. \t Pct. \t Cum Pct. \n");
  }
  ...
  public void test75()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      Frequency frequency0 = new Frequency(comparator0);
      long long0 = frequency0.getCumFreq((Object) "G9ECd8RZM");
  }

  @Test(timeout = 4000)
  public void test76()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCumFreq(1190);
  }
