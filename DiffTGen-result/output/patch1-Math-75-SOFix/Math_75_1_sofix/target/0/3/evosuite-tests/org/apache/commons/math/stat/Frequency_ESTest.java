...
public class Frequency_ESTest extends Frequency_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      frequency0.addValue((-1519L));
      frequency0.addValue(1341L);
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn((-3092), 0, (-1), 341, (-1)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(0, 1384).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test06()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue(2268);
      double double0 = frequency0.getPct(2268);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0);
      double double0 = frequency0.getCumPct(546L);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-3092), 0, (-1)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0);
  ...
  public void test22()  throws Throwable  {
      ...
      frequency0.addValue(integer0);
      long long0 = frequency0.getCount((long) 1111);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Integer integer0 = new Integer((-3206));
      frequency0.addValue(integer0);
      long long0 = frequency0.getCount((-3206));
  }
  ...
  public void test44()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(0, 1384, 0, (-1)).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      Integer integer0 = new Integer(668);
      frequency0.addValue(integer0);
      double double0 = frequency0.getCumPct((Comparable<?>) "Value \t Freq. \t Pct. \t Cum Pct. \n668\t0\t0%\t0%\n");
  ...
  public void test59()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(0, 1384, 0, (-1), (-1)).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      Integer integer0 = new Integer(668);
      frequency0.addValue(integer0);
      double double0 = frequency0.getCumPct(1447L);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(2114, (-1368), 2114, (-1368), 2114).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      Integer integer0 = new Integer(668);
      frequency0.addValue(integer0);
      double double0 = frequency0.getCumPct(1447L);
  ...
  public void test67()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCount((-1628L));
  }

  @Test(timeout = 4000)
  public void test68()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCount(1773);
  }
  ...
  public void test76()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCumFreq((-1416));
  }
  ...
  public void test78()  throws Throwable  {
      ...
      Integer integer0 = new Integer(270);
      frequency0.addValue(integer0);
      long long0 = frequency0.getCumFreq((-2444L));
  }
}
