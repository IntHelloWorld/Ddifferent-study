...
public class Frequency_ESTest extends Frequency_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      double double0 = frequency0.getPct(comparable1);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(1572, (-1502)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test04()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(31, 31).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test05()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(641, 641).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test06()  throws Throwable  {
      ...
      Integer integer0 = new Integer(2061);
      frequency0.addValue((Object) integer0);
      double double0 = frequency0.getPct((-1114L));
  }
  ...
  public void test07()  throws Throwable  {
      ...
      frequency0.addValue(comparable0);
      double double0 = frequency0.getPct((long) 2105);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(2656, 10).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0L);
  ...
  public void test09()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue('7');
      double double0 = frequency0.getPct((-429));
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1073741824, (-1)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test15()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1073741824, (-1), 1073741824, (-1130), (-1130)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(1L);
      double double0 = frequency0.getCumPct(1240L);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(1L);
      double double0 = frequency0.getCumPct((-1130));
  }
  ...
  public void test20()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(641, 641, 641, 641).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0L);
  ...
  public void test45()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      Comparable<Object> comparable0 = (Comparable<Object>) mock(Comparable.class, new ViolatedAssumptionAnswer());
      doReturn((-2206)).when(comparable0).compareTo(any());
      frequency0.addValue(comparable0);
      // Undeclared exception!
      try { 
        frequency0.addValue('T');
  ...
  public void test47()  throws Throwable  {
      Comparator<Long> comparator0 = (Comparator<Long>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(2656, 10, 10, 10, (-1358)).when(comparator0).compare(anyLong() , anyLong());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0L);
  ...
  public void test49()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(1572, (-1502), 1013, 1013).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      Integer integer0 = new Integer((-816));
      frequency0.addValue(integer0);
  ...
  public void test54()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      Frequency frequency0 = new Frequency(comparator0);
      long long0 = frequency0.getCount((Comparable<?>) 153);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      long long0 = frequency0.getCumFreq((-3790));
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(0);
      double double0 = frequency0.getCumPct(2514);
  }
  ...
  public void test74()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCumFreq((-320));
  }
}
