...
public class SimplexSolver_ESTest extends SimplexSolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      simplexTableau0.numArtificialVariables = (-1964);
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(348.602997648, 59.5024410538).when(linearConstraint0).getValue();
  ...
  public void test04()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0);
      ArrayRealVector arrayRealVector0 = new ArrayRealVector();
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(arrayRealVector0, (-552.380401332146));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
  ...
  public void test06()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-2122.103));
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver();
      simplexSolver0.setMaxIterations((-489));
      try { 
        simplexSolver0.doIteration((SimplexTableau) null);
      } catch(Exception e) {
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Maximal number of iterations (-489) exceeded
         //
  ...
  public void test09()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-204.50318549294647));
      // Undeclared exception!
      try { 
        simplexSolver0.doIteration((SimplexTableau) null);
      } catch(NullPointerException e) {
  ...
  public void test14()  throws Throwable  {
      ...
      doReturn(arrayRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship0).when(linearConstraint0).getRelationship();
      doReturn(348.602997648, (double)100).when(linearConstraint0).getValue();
      boolean boolean0 = linkedList0.add(linearConstraint0);
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 0.0);
      simplexSolver0.solvePhase1(simplexTableau0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      doubleArray0[1] = (double) 100;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 2535.27);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      try { 
