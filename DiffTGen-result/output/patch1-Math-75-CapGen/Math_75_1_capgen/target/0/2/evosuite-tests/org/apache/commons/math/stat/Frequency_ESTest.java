...
public class Frequency_ESTest extends Frequency_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      double double0 = frequency0.getPct((Object) "c");
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(4497, 4497).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn((-2243), (-2243)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
  ...
  public void test06()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue(2438L);
      double double0 = frequency0.getPct(2438L);
  }
  ...
  public void test10()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-186), 1807).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(1331L);
  ...
  public void test13()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-186), 1807, 1807, (-186)).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(1331L);
  ...
  public void test15()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      frequency0.addValue('v');
      double double0 = frequency0.getCumPct((-3052));
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue('@');
      double double0 = frequency0.getCumPct((-566));
  }
  ...
  public void test18()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(4497, 4497, 1, 1).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-1));
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = new Integer((-1));
      frequency0.addValue(integer0);
      long long0 = frequency0.getCumFreq(412);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue((-354));
      long long0 = frequency0.getCount((-354));
  }
  ...
  public void test46()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-2243), (-2243), (-2243)).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue('y');
  ...
  public void test57()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCount((-3446L));
  }
  ...
  public void test67()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCount(59);
  }
  ...
  public void test76()  throws Throwable  {
      Comparator<Integer> comparator0 = (Comparator<Integer>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn((-186)).when(comparator0).compare(anyInt() , anyInt());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue(1331L);
      Frequency frequency1 = new Frequency();
      boolean boolean0 = frequency0.equals(frequency1);
