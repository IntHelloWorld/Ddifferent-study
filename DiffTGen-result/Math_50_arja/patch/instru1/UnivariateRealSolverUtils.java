...
public class UnivariateRealSolverUtils {
	...
	public static int eid_forceSide_int_UnivariateRealFunction_BracketedUnivariateRealSolverLTEMPUnivariateRealFunctionRTEMP_double_double_double_AllowedSolution_7au3e = 0;
	...
	public static int eid_isBracketing_UnivariateRealFunction_double_double_7au3e = 0;
	public static int eid_isSequence_double_double_double_7au3e = 0;
	public static int eid_verifyInterval_double_double_7au3e = 0;
	public static int eid_verifySequence_double_double_double_7au3e = 0;
	public static int eid_verifyBracketing_UnivariateRealFunction_double_double_7au3e = 0;
	...
	public static void clearORefMap() {
		...
		eid_forceSide_int_UnivariateRealFunction_BracketedUnivariateRealSolverLTEMPUnivariateRealFunctionRTEMP_double_double_double_AllowedSolution_7au3e = 0;
		...
		eid_isBracketing_UnivariateRealFunction_double_double_7au3e = 0;
		eid_isSequence_double_double_double_7au3e = 0;
		eid_verifyInterval_double_double_7au3e = 0;
		eid_verifySequence_double_double_double_7au3e = 0;
		eid_verifyBracketing_UnivariateRealFunction_double_double_7au3e = 0;
	}
     ...
     * endpoints.
     */
    public static void verifyBracketing_7au3e(UnivariateRealFunction function,
                                        final double lower,
                                        final double upper) {
	 ...
	 * @param lower  Lower endpoint.
	 * @param upper  Upper endpoint.
	 * @throws NoBracketingException  if function has the same sign at the endpoints.
	 */
	public static void verifyBracketing(UnivariateRealFunction function,
		...
		String msig_7au3e = "verifyBracketing(UnivariateRealFunction$double$double)"
				+ eid_verifyBracketing_UnivariateRealFunction_double_double_7au3e;
		try {
			verifyBracketing_7au3e(function, lower, upper);
